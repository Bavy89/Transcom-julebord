...
const PartyDetails = () => {
  ...
  const details = [
    ...
    },
    {
      icon: Clock,
      title: "Tid",
      info: "18:30 - festen varer til du er på do og spyr men kan være der litt til og kjøpe kebab på nellys..."
    },
    {
      icon: MapPin,
      title: "Lokasjon",
      ...
      >
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-12">
            Nydelig tre-retters middag fra Scandic 🍽️
          </p>
        </motion.div>

        <motion.div
          className="bg-card/50 backdrop-blur-sm rounded-2xl p-8 border border-party-blue/20 overflow-hidden"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="mt-6 text-center">
            <Button
              variant="outline"
              size="lg"
              className="bg-party-blue/10 border-party-blue/30 text-party-blue hover:bg-party-blue/20"
              onClick={() => {
                const link = document.createElement('a');
                link.href = '/images/scandic-menu1.png';
                link.download = 'Transcom-Julebord-2025-Meny.png';
        ...
        >
          <p className="text-sm text-muted-foreground">
            Allergener: S = Skalldyr, E = Egg, Sn = Sennep, M = Melk, Sl = Selleri, N = Nøtter, Su = Sulfitt
          </p>
        </motion.div>
      </motion.div>
    </section>
...
const NomineesList = () => {
  ...
  return (
    <section ref={nomineesRef} className="py-20 px-6 bg-gradient-to-b from-background to-party-blue/5">
      <motion.div
        className="max-w-6xl mx-auto"
        initial={{ opacity: 0 }}
        animate={isInView ? { opacity: 1 } : {}}
      ...
      >
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Gratulerer til alle nominerte i alle priser! 🎉
          </p>
        </motion.div>
          ...
          {categories.map((category, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                <Star className="w-6 h-6 text-party-blue mr-3" />
              ...
              <ul className="space-y-3">
                {category.nominees.map((nominee, i) => (
                  <motion.li
                    key={i}
                    className="text-muted-foreground pl-4 border-l-2 border-party-blue/20"
        ...
        >
          <p className="text-muted-foreground italic">
            Vinnerne blir annonsert under festen! 🏆
          </p>
        </motion.div>
      </motion.div>
    </section>
    ...
    <footer ref={footerRef} className="py-16 px-6 text-center">
      ...
      >
        <p className="text-lg text-muted-foreground mb-6">
          Vi gleder oss til en fantastisk kveld sammen! 🎉
        </p>
